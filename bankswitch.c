...
#define NES_CHR_BANKS 1		// # of 8KB CHR banks (Has to be at least 1 for MMC3 bank switching - Remove the segments from CC65 config, correct the header after export
...
#pragma rodata-name("RODATA") //Restore default location for future read-only data
